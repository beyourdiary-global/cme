...
$orderNumber = $_GET['order'] ?? 'ORD-935721';
$orderDate = date('F j, Y');
$orderTotal = $_GET['total'] ?? '$238.67';
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div class="row g-0">
            ...
            <div class="col-lg-4 sidebar" data-aos="fade-right">
              <div class="sidebar-content">
                ...
                <div class="order-id">
                  <h4>Order #<?= htmlspecialchars($orderNumber) ?></h4>
                  <div class="order-date"><?= htmlspecialchars($orderDate) ?></div>
                </div>
                ...
                <div class="delivery-info">
                  ...
                  <p class="delivery-estimate">
                    ...
                    <span>Estimated delivery: <?= date('F j-j, Y', strtotime('+5 days')) ?></span>
                  </p>
                ...
                <div class="customer-service">
                  ...
                  <a href="faq.php" class="help-link">
