...
// Here you would fetch products from database
// For now, using placeholder data
$products = []; // This would come from your database
$total_products = 0; // This would be the total count from database
      ...
      <div class="container">
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current"><?= ucfirst(htmlspecialchars($category)) ?></li>
          </ol>
        </nav>
        <h1><?= ucfirst(htmlspecialchars($category)) ?></h1>
      </div>
    </div><!-- End Page Title -->
              ...
              <div class="row gy-4">
                  ...
                  <div class="product-box">
                    ...
                    <div class="product-content">
                      <div class="product-details">
                        <h3 class="product-title"><a href="product-details.php">Vestibulum ante ipsum primis</a></h3>
                ...
                <div class="col-lg-6">
                  <div class="product-box">
                    ...
                    <div class="product-content">
                      <div class="product-details">
                        <h3 class="product-title"><a href="product-details.php">Aliquam tincidunt mauris eu risus</a></h3>
                        <div class="product-price">
                ...
                <div class="col-lg-6">
                  <div class="product-box">
                    ...
                    <div class="product-content">
                      <div class="product-details">
                        <h3 class="product-title"><a href="product-details.php">Cras ornare tristique elit</a></h3>
                        <div class="product-price">
                          <span>$89.50</span>
                        </div>
                      </div>
                ...
                <div class="col-lg-6">
                  <div class="product-box">
                    ...
                    <div class="product-content">
                      <div class="product-details">
                        <h3 class="product-title"><a href="product-details.php">Integer vitae libero ac risus</a></h3>
                        <div class="product-price">
                          <span>$119.00</span>
                        </div>
                      </div>
                ...
                <div class="col-lg-6">
                  <div class="product-box">
                    ...
                    <div class="product-content">
                      <div class="product-details">
                        <h3 class="product-title"><a href="product-details.php">Donec eu libero sit amet quam</a></h3>
                        <div class="product-price">
                          <span>$75.00</span>
                        </div>
                      </div>
                ...
                <div class="col-lg-6">
                  <div class="product-box">
                    ...
                    <div class="product-content">
                      <div class="product-details">
                        <h3 class="product-title"><a href="product-details.php">Pellentesque habitant morbi tristique</a></h3>
                        <div class="product-price">
                          <span>$64.95</span>
                        </div>
                      </div>
